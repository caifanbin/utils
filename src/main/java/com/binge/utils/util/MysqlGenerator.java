...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir(projectPath + "/com/elimen/ins/broker");
		// TODO 设置用户名
		gc.setAuthor("elimen");
		gc.setOpen(true);
		// service 命名方式
		...
		pc.setParent("com.elimen.ins.broker");
		pc.setEntity("entity");
		...
		strategy.setNaming(NamingStrategy.underline_to_camel).setTablePrefix("Eb_");
